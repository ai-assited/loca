...
package com.med.buddy.ai.gallery.ui.navigation
...
import com.med.buddy.ai.gallery.data.TASK_LLM_ASK_AUDIO
import com.med.buddy.ai.gallery.data.TASK_LLM_ASK_IMAGE
import com.med.buddy.ai.gallery.data.TASK_LLM_CHAT
import com.med.buddy.ai.gallery.data.TASK_LLM_PROMPT_LAB
import com.med.buddy.ai.gallery.data.Task
import com.med.buddy.ai.gallery.data.TaskType
import com.med.buddy.ai.gallery.data.getModelByName
import com.med.buddy.ai.gallery.firebaseAnalytics
import com.med.buddy.ai.gallery.ui.home.HomeScreen
import com.med.buddy.ai.gallery.ui.llmchat.LlmAskAudioDestination
import com.med.buddy.ai.gallery.ui.llmchat.LlmAskAudioScreen
import com.med.buddy.ai.gallery.ui.llmchat.LlmAskAudioViewModel
import com.med.buddy.ai.gallery.ui.llmchat.LlmAskImageDestination
import com.med.buddy.ai.gallery.ui.llmchat.LlmAskImageScreen
import com.med.buddy.ai.gallery.ui.llmchat.LlmAskImageViewModel
import com.med.buddy.ai.gallery.ui.llmchat.LlmChatDestination
import com.med.buddy.ai.gallery.ui.llmchat.LlmChatScreen
import com.med.buddy.ai.gallery.ui.llmchat.LlmChatViewModel
import com.med.buddy.ai.gallery.ui.llmsingleturn.LlmSingleTurnDestination
import com.med.buddy.ai.gallery.ui.llmsingleturn.LlmSingleTurnScreen
import com.med.buddy.ai.gallery.ui.llmsingleturn.LlmSingleTurnViewModel
import com.med.buddy.ai.gallery.ui.modelmanager.ModelManager
import com.med.buddy.ai.gallery.ui.modelmanager.ModelManagerViewModel
...
fun GalleryNavHost(
  ...
  if (data != null) {
    ...
    if (data.toString().startsWith("com.med.buddy.ai.gallery://model/")) {
